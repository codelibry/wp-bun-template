...
!(function (t, e) {
	...
	function ub(t, e, r) {
		...
		if (
			((u = u.map(function (t) {
				return (
					(t = sb(t, e, 1)) && h + (e ? t[0] + ',' + t[1] + '%,' + t[2] + '%,' + t[3] : t.join(',')) + ')'
				);
			})),
	...
	var It,
		...
		Nt =
			...
			(It.isActive = function isActive() {
				...
				return !(
					e &&
					!(this._ts && this._initted && e.isActive() && (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - V)
				);
			}),
	...
	var Ut = (function (n) {
		...
		return (
			...
			(e.staggerFromTo = function staggerFromTo(e, r, i, n, a, s, o, u) {
				return (
					(n.startAt = i), (pa(n).immediateRender = t(n.immediateRender)), this.staggerTo(e, r, n, a, s, o, u)
				);
			}),
			(e.render = function render(t, e, r) {
				...
				if ((this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
					...
					if (
						...
						(this._act = !l),
						this._initted ||
							((this._onUpdate = this.vars.onUpdate), (this._initted = 1), (this._zTime = t), (c = 0)),
						...
						ka(
							{
								...
								overwrite: 'auto',
								duration:
									e.duration || Math.abs((n - (a && 'time' in a ? a.time : i._time)) / i.timeScale()) || V,
								onStart: function onStart() {
									if ((i.pause(), !r)) {
										var t =
											e.duration || Math.abs((n - (a && 'time' in a ? a.time : i._time)) / i.timeScale());
	...
	function xd(t) {
		...
		return (
			i && (n ? i.insertBefore(this, n) : i.appendChild(this)), de.removeChild(r), (this.style.cssText = a), e
		);
	}
	function yd(t, e) {
	...
	var le,
		...
		ar = function _renderSVGTransforms(t, e) {
			...
			(d = parseFloat(d)),
				...
				(u || h) &&
					((s = g.getBBox()), (x = ca(x + (u / 100) * s.width)), (k = ca(k + (h / 100) * s.height))),
